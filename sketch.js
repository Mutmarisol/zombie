...
function setup() {
  ...
  leftWall = new Base(50, height / 2 + 50, 600, 100, "#00FFFF", true);
  rightWall = new Base(width - 100, height / 2 + 50, 600, 100, "#00FFFF", true);
  ...
  jointPoint = new Base(width - 345, height / 2 + 10, 40, 20, "	#FF69B4", true);
